    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                var w = $("<div " + k(l, "entrieBox", !1, "ui-jqgrid") + "></div>");
                $(w).attr({
                    id: "gbox_" + this.id,
                    dir: h
                ...
                var x, y = ["shiftKey", "altKey", "ctrlKey"],
                    z = function(a, b) {
                    ...
                    N = function(a, b, c, e) {
                        ...
                        if (a) {
                            ...
                            var m, o, p, q, r, s, t, u, v, w, x, y, A = $(d),
                                B = 0,
                                C = [],
                    ...
                    O = function() {
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            if ($.each(d.p.colModel, function() {
                                ...
                                }), d.p.multiSort && (g = t, h = u), d.p.treeGrid && d.p._sort) return void $(d).jqGrid("SortTree", g, d.p.sortorder, j[g].stype || "text", j[g].srcfmt || "");
                            var q = {
                                    eq: function(a) {
                                        return a.equals
                                    },
                            ...
                            if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
                                ...
                                if (s) "string" == typeof s && (s = $.jgrid.parse(s)), a(s);
                                else try {
                                ...
                                case "script":
                                    $.ajax($.extend({
                                        ...
                                        success: function(c, f, g) {
                                            return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void R() : ("xml" === b ? M(c, o, a > 1, j) : N(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void(1 === a && R()))
                                        },
                                        ...
                                        beforeSend: function(a, b) {
                                            var c = !0;
                                            return $.isFunction(d.p.loadBeforeSend) && (c = d.p.loadBeforeSend.call(d, a, b)), void 0 === c && (c = !0), c === !1 ? !1 : void Q()
                                        }
                                    }, $.jgrid.ajaxOptions, d.p.ajaxGridOptions));
                                    break;
                                case "xmlstring":
                                    Q(), c = "string" != typeof d.p.datastr ? d.p.datastr : $.parseXML(d.p.datastr), M(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, R();
                                    break;
                                case "jsonstring":
                                    Q(), c = "string" == typeof d.p.datastr ? $.jgrid.parse(d.p.datastr) : d.p.datastr, N(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, R();
                                    break;
                                case "local":
                                case "clientside":
                    ...
                    V = function(a, b, c) {
                        var e, f = d.p.colModel,
                            g = d.p.frozenColumns ? b : d.grid.headers[a].el,
                            h = "";
                        $("span.ui-grid-ico-sort", g).addClass(m), $(g).attr("aria-selected", "false"), e = f[a].index || f[a].name, "undefined" == typeof c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : ("asc-desc" === f[a].lso || "desc-asc" === f[a].lso) && (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc" : f[a].lso = h = c, h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(m), $(g).attr("aria-selected", "true")) : d.p.viewsortcols[0] || $("span.s-ico", g).hide();
                        var i = t.indexOf(e); - 1 === i ? (t.push(e), u.push(h)) : h ? u[i] = h : (u.splice(i, 1), t.splice(i, 1)), d.p.sortorder = "", d.p.sortname = "";
                        for (var j = 0, k = t.length; k > j; j++) j > 0 && (d.p.sortname += ", "), d.p.sortname += t[j], j !== k - 1 && (d.p.sortname += " " + u[j]);
                        d.p.sortorder = u[k - 1]
                    },
                    ...
                    ba = function(a, b, c, e) {
                        var f, g, h, i, j, k = d.p.colModel[a],
                            l = "",
                            m = "",
                            n = "",
                            p = "",
                        ...
                        if (k) {
                            ...
                            var x = "<div>" + $.jgrid.getRegional(d, "colmenu.searchTitle") + "</div>";
                    ...
                    fa = function(a, b, c) {
                        ...
                        var e, f, g = $(".ui-jqgrid-view").css("font-size") || "11px",
                ...
                var ia, ja, ka, la, ma, na, oa, pa, qa, ra = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    sa = "",
                    ta = "",
                    ua = "";
                ...
                for (i = 0; i < this.p.colNames.length; i++) {
                    var va = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"' : "";
                    qa = d.p.colModel[i], qa.hasOwnProperty("colmenu") || (qa.colmenu = "rn" === qa.name || "cb" === qa.name || "subgrid" === qa.name ? !1 : !0), ra += "<th id='" + d.p.id + "_" + qa.name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + va + ">", ja = qa.index || qa.name, ra += "<div class='ui-th-div' id='jqgh_" + d.p.id + "_" + qa.name + "' " + ia + ">" + d.p.colNames[i], qa.width ? qa.width = parseInt(qa.width, 10) : qa.width = 150, "boolean" != typeof qa.title && (qa.title = !0), qa.lso = "", ja === d.p.sortname && (d.p.lastsort = i), d.p.multiSort && (v = $.inArray(ja, t), -1 !== v && (qa.lso = u[v])), ra += pa, d.p.colMenu && qa.colmenu && (ra += "<a class='colmenu' href='#/'><span class='colmenuspan " + q + " " + r.icon_menu + "'></span></a>"), ra += "</div></th>"
                }
                ...
                if (d.p.disableClick = !1, $("th", Aa).each(function(a) {
                        qa = d.p.colModel[a], ka = qa.width, void 0 === qa.resizable && (qa.resizable = !0), qa.resizable ? (la = document.createElement("span"), $(la).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : la = "", $(this).css("width", ka + "px").prepend(la), la = null;
                        var b = "";
                        qa.hidden && ($(this).css("display", "none"), b = "display:none;"), Ba += "<td role='gridcell' style='height:0px;width:" + ka + "px;" + b + "'></td>", e.headers[a] = {
                            width: ka,
                            el: this
                        }, sa = qa.sortable, "boolean" != typeof sa && (qa.sortable = !0, sa = !0);
                        var c = qa.name;
                        ...
                        if (1 === f.length) {
                            ...
                            if ($(a.target).hasClass("colmenuspan")) {
                                ...
                                var j = $(this).offset(),
                                    k = j.left,
                                    l = j.top;
                                return "ltr" === d.p.direction && (k += $(this).outerWidth()), fa(i, k, l, f), void a.stopPropagation()
                            }
                ...
                var Da = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ra),
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    var b = $(ma).filter(":enabled").hasClass("cbox"),
                    ...
                    if ("A" !== ma.tagName && ("INPUT" !== ma.tagName && "TEXTAREA" !== ma.tagName && "OPTION" !== ma.tagName && "SELECT" !== ma.tagName || b))
                        if (Ha = na[0].id, ma = $(ma).closest("tr.jqgrow>td"), ma.length > 0 && (Ia = $.jgrid.getCellIndex(ma), Ja = $(ma).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, Ha, Ia, Ja, a)), d.p.cellEdit !== !0) {
                            ...
                            else $(d).jqGrid("setSelection", Ha, !0, a)
                        } else if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", Ha, !0, a);
                    else if (ma.length > 0) try {
                    ...
                    if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
                        ...
                        var b = $(d).triggerHandler("jqGridDblClickRow", [$(na).attr("id"), Ha, Ia, a]);
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(na).attr("id"), Ha, Ia, a), null != b) ? b : void 0
                    }
                }).bind("contextmenu", function(a) {
                    if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
                        d.p.multiselect || $(d).jqGrid("setSelection", na[0].id, !0, a), Ha = na[0].rowIndex, Ia = $.jgrid.getCellIndex(ma);
                        var b = $(d).triggerHandler("jqGridRightClickRow", [$(na).attr("id"), Ha, Ia, a]);
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(na).attr("id"), Ha, Ia, a), null != b) ? b : void 0
                    }
                ...
                var Ka = q + " " + k(l, "icon_caption_open", !0),
                    La = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var Ma = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                    Ma.addClass(o)
                }, function() {
                    Ma.removeClass(o)
                ...
                if ($(e.cDiv).append(Ma).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                    var Na = k(l, "customtoolbarBox", !0, "ui-userdata");
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
                        ...
                        var a = e.bDiv.offsetWidth - e.bDiv.clientWidth;
                            ...
                            success: function(a) {
                                ...
                                if ("string" == typeof l && (l = $($.trim(l)).html()), l) {
                                    if ($(d).append(l), f(d, g, n ? ["postData"] : void 0), void 0 === g.size && (g.size = i ? 3 : 1), i ? (c = e.split(","), c = $.map(c, function(a) {
                                        ...
                                        $.each(o, function(a) {
                                            return m = this.index || this.name, g.name === m ? (this.searchoptions.dataUrl = null, this.searchoptions.value = k, !1) : void 0
                                        })
                                    }
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
                    ...
                    this.onchange = function() {
                        ...
                        var v = e.p.ruleButtons && e.p.uniqueSearchFields;
                        if (v)
                            for (var w = 0; w < e.p.columns.length; w++) e.p.columns[w].inlist && (e.p.columns[w].search = !0);
                        if (void 0 !== a.rules)
                            for (c = 0; c < a.rules.length; c++)
                                if (f.append(this.createTableRowForRule(a.rules[c], a)), v)
                                    for (var x = a.rules[c].field, w = 0; w < e.p.columns.length; w++)
                                        if (x === e.p.columns[w].name) {
                                            e.p.columns[w].search = !1;
                                            break
                                        }
                        return f
                        ...
                        q.append(s), s.bind("change", function() {
                            ...
                            if (k) {
                                ...
                                for (t = [], $.each(m.p.ops, function() {
                                        t.push(this.oper)
                                    }), c = 0; c < g.length; c++) r = $.inArray(g[c], t), -1 !== r && (0 === l && (a.op = m.p.ops[r].oper), i += "<option value='" + m.p.ops[r].oper + "'>" + m.p.ops[r].text + "</option>", l++);
                                ...
                                $(".data", j).append(f), $.jgrid.bindEv.call(n, f, k.searchoptions), $(".input-elm", j).bind("change", function(b) {
                                    var c = b.target;
            ...
            return a = $.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        ...
                        j = function() {
                            ...
                            $.each(c.p.colModel, function() {
                                var m = $("#gs_" + c.p.idPrefix + $.jgrid.jqID(this.name), this.frozen === !0 && c.p.frozenColumns === !0 ? c.grid.fhDiv : c.grid.hDiv);
                                if (d = this.index || this.name, f = this.searchoptions || {}, e = a.searchOperators && f.searchOperMenu ? m.parent().prev().children("a").attr("soper") || a.defaultSearch : f.sopt ? f.sopt[0] : "select" === this.stype ? "eq" : a.defaultSearch, b = "custom" === this.stype && $.isFunction(f.custom_value) && m.length > 0 && "SPAN" === m[0].nodeName.toUpperCase() ? f.custom_value.call(c, m.children(".customelement:first"), "get") : m.val(), "select" === this.stype && f.multiple && $.isArray(b) && b.length && (j = !0, k.push(d), b = 1 === b.length ? b[0] : b), "bt" === e && (l = !0), b || "nu" === e || "nn" === e) g[d] = b, i[d] = e, h++;
                                else try {
                            ...
                            if (a.stringResult === !0 || "local" === c.p.datatype || a.searchOperators === !0) {
                                var n = '{"groupOp":"' + a.groupOp + '","rules":[',
                                    o = 0;
                                $.each(g, function(a, b) {
                                    o > 0 && (n += ","), n += '{"field":"' + a + '",', n += '"op":"' + i[a] + '",', b += "", n += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}',
                                        o++
                                }), n += "]}";
                                var p, q, r, s, t, u, v;
                                if (j && (p = $.jgrid.parse(n), p.rules && p.rules.length))
                                    for (q = p.rules, r = 0; r < q.length; r++) t = q[r], $.inArray(t.filed, k) && (u = t.data.split(a.splitSelect), u.length > 1 && (void 0 === p.groups && (p.groups = []), v = {
                                        groupOp: a.groupOpSelect,
                                        groups: [],
                                        rules: []
                                    }, p.groups.push(v), $.each(u, function(a) {
                                        s = u[a], s && v.rules.push({
                                            data: u[a],
                                            op: t.op,
                                            field: t.field
                                        })
                                    }), q.splice(r, 1), r--));
                                if (l && ($.isPlainObject(p) || (p = $.jgrid.parse(n)), p.rules && p.rules.length))
                            ...
                            var w;
                            c.p.searchurl && (w = c.p.url, $(c).jqGrid("setGridParam", {
                                url: c.p.searchurl
                            }));
                            var x = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                    ...
                    a.restoreFromFilters && (f = c.p.postData.filters, f && ("string" == typeof f && (f = $.jgrid.parse(f)), e = f.rules.length ? f.rules : !1)), $.each(c.p.colModel, function(b) {
                        ...
                        if (this.hidden === !0 && $(u).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {}, void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), f = $.extend({}, this.searchoptions, {
                                name: r.index || r.name,
                        ...
                        "select" === c.p.colModel[e].stype ? (b = $("td.ui-search-input select", d), g ? b.val(g) : b[0].selectedIndex = 0) : (b = $("td.ui-search-input input", d), b.val(g)), $(c).triggerHandler("jqGridToolbarClearVal", [b[0], e, f, g]), $.isFunction(a.onClearSearchValue) && a.onClearSearchValue.call(c, b[0], e, f, g), a.autosearch === !0 && j()
        ...
        refreshFilterToolbar: function(a) {
            return a = $.extend(!0, {
                ...
                function b(e) {
                    if (e && e.rules) {
                        for (f = e.rules, k = f.length, c = 0; k > c; c++) g = f[c], h = $.inArray(g.field, l), -1 !== h && (d = $("#gs_" + i.p.idPrefix + $.jgrid.jqID(j[h].name)), d.length > 0 && ("select" === j[h].stype ? d.find("option[value='" + $.jgrid.jqID(g.data) + "']").prop("selected", !0) : "text" === j[h].stype && d.val(g.data), $.isFunction(a.onSetVal) && a.onSetVal.call(i, d, j[h].name)));
                        if (e.groups)
            ...
            return b = $.extend(!0, {
                ...
                if (c.grid) {
                    ...
                    if (a += "", "local" !== !c.p.datatype) {
                        $.each(c.p.colModel, function() {
                            d = this.index || this.name, e = this.searchoptions || {}, f = b.defaultSearch ? b.defaultSearch : e.sopt ? e.sopt[0] : b.defaultSearch, this.search = this.search === !1 ? !1 : !0, (this.search || b.searchAll) && (h > 0 && (g += ","), g += '{"field":"' + d + '",', g += '"op":"' + f + '",', g += '"data":"' + a.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', h++)
                        }), g += "]}", $.extend(c.p.postData, {
                            filters: g
                        }), $.each(["searchField", "searchString", "searchOper"], function(a, b) {
                            c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                        });
                        var i = "stop" === $(c).triggerHandler("jqGridFilterInputBeforeSearch") ? !0 : !1;
    ...
    if ($.jgrid.extend({
            editGridRow: function(a, b) {
                ...
                return b = $.extend(!0, {
                    ...
                    function d(a, b, c, d) {
                        ...
                        if ("_empty" !== a && (p = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function(l) {
                                if (f = this.name, g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
                                    if (p === !1) i = "";
                                    else if (f === b.p.ExpandColumn && b.p.treeGrid === !0) i = $("td[role='gridcell']:eq(" + l + ")", b.rows[p]).text();
                                    else {
                                        try {
                                    ...
                                    var t = $.extend({}, this.editoptions || {}, {
                                        ...
                                        v = parseInt(u.rowpos, 10) || n + 1,
                                        x = parseInt(2 * (parseInt(u.colpos, 10) || 1), 10);
                                    if ("_empty" === a && t.defaultValue && (i = $.isFunction(t.defaultValue) ? t.defaultValue.call(q) : t.defaultValue), this.edittype || (this.edittype = "text"), q.p.autoencode && (i = $.jgrid.htmlDecode(i)), k = $.jgrid.createEl.call(q, this.edittype, t, i, !1, $.extend({}, $.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {})), "select" === this.edittype && (i = $(k).val(), "select-multiple" === $(k).get(0).type && i && (i = i.join(","))), "checkbox" === this.edittype && (i = $(k).is(":checked") ? $(k).val() : $(k).attr("offval")), $(k).addClass("FormElement"), $.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && $(k).addClass(e.inputClass), m = !0, D) {
                                        var y = $(J).find("#" + f);
                                        y.length ? y.replaceWith(k) : m = !1
                                    } else {
                                        if (h = $(c).find("tr[rowpos=" + v + "]"), u.rowabove) {
                                            var z = $("<tr><td class='contentinfo' colspan='" + 2 * d + "'>" + u.rowcontent + "</td></tr>");
                                            $(c).append(z), z[0].rp = v
                                        }
                                        0 === h.length && (h = $("<tr " + j + " rowpos='" + v + "'></tr>").addClass("FormData").attr("id", "tr_" + f), $(h).append(s), $(c).append(h), h[0].rp = v), $("td:eq(" + (x - 2) + ")", h[0]).html("<label for='" + f + "'>" + (void 0 === u.label ? b.p.colNames[l] : u.label) + "</label>"), $("td:eq(" + (x - 1) + ")", h[0]).append(u.elmprefix).append(k).append(u.elmsuffix)
                                    }(rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && m && (q.p.savedData[f] = i), "custom" === this.edittype && $.isFunction(t.custom_value) && t.custom_value.call(q, $("#" + f, w), "set", i), $.jgrid.bindEv.call(q, k, t), o[n] = l, n++
                                }
                            }), n > 0) {
                            var t;
                    ...
                    function g(a, b, c) {
                        ...
                        l && ($('td[role="gridcell"]', l).each(function(f) {
                            if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                                ...
                                switch (q.p.autoencode && (e = $.jgrid.htmlDecode(e)), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (q.p.savedData[d] = e), d = $.jgrid.jqID(d), k[f].edittype) {
                                    case "password":
                                    case "text":
                                    case "button":
                                    case "image":
                                    ...
                                    case "select":
                                        ...
                                        }), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).val(), k[f].editoptions.multiple && (e = e.join(",")), q.p.savedData[d] = e);
                                        break;
                                    case "checkbox":
                                        ...
                                        (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval"), q.p.savedData[d] = e);
                                        break;
                                    case "custom":
                                        try {
                        ...
                        }), j > 0 && ($("#id_g", y).val(a), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (q.p.savedData[b.p.id + "_id"] = a)))
                    }
                    ...
                    function j(a, b) {
                        var c, d = !1;
                        if (d = !($.isPlainObject(a) && $.isPlainObject(b) && Object.getOwnPropertyNames(a).length === Object.getOwnPropertyNames(b).length), !d)
                            for (c in b)
                    ...
                    function k() {
                        var a = !0;
                        return $(".FormError", w).hide(), rp_ge[q.p.id].checkOnUpdate && (s = {}, c(), t = j(s, q.p.savedData), t && ($(w).data("disabled", !0), $(".confirm", "#" + z.themodal).show(), a = !1)), a
                    }
                    ...
                    function n() {
                        ...
                        if (q.p.multiselect && rp_ge[q.p.id].editselected) {
                            for (var d = [], e = 0, f = b.length; f > e; e++) - 1 !== $.inArray(b[e], q.p.selarrrow) && d.push(b[e]);
                    ...
                    if (q.grid && a) {
                        ...
                        if (D ? (G = o(rp_ge[$(this)[0].p.id].template), r = y) : (G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>"), r = y + "_2"), w = "#" + $.jgrid.jqID(w), $(J).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(J).append("<div class='tinfo topinfo'>" + rp_ge[q.p.id].topinfo + "</div>"), $(q.p.colModel).each(function() {
                            ...
                            $(q).triggerHandler("jqGridAddEditInitializeForm", [$(w), u]), $.isFunction(rp_ge[q.p.id].onInitializeForm) && rp_ge[q.p.id].onInitializeForm.call(q, $(w), u), "_empty" !== a && rp_ge[q.p.id].viewPagerButtons ? $("#pData,#nData", r).show() : $("#pData,#nData", r).hide(), $(q).triggerHandler("jqGridAddEditBeforeShowForm", [$(w), u]), $.isFunction(rp_ge[q.p.id].beforeShowForm) && rp_ge[q.p.id].beforeShowForm.call(q, $(w), u), p(), $("#" + $.jgrid.jqID(z.themodal)).data("onClose", rp_ge[q.p.id].onClose), $.jgrid.viewModal("#" + $.jgrid.jqID(z.themodal), {
                                ...
                                return s = {}, $(".FormError", w).hide(), c(), "_empty" === s[q.p.id + "_id"] ? i() : b.checkOnSubmit === !0 ? (t = j(s, q.p.savedData), t ? ($(w).data("disabled", !0), $(".confirm", "#" + $.jgrid.jqID(z.themodal)).show()) : i()) : i(), !1
            ...
            saveState: function(a, b) {
                if (b = $.extend({
                    ...
                    var c, d, e = "",
                        ...
                        g = $("#" + a)[0];
                    if (g.grid) {
                        d = $(g).data("inlineNav"), d && g.p.inlineNav && $(g).jqGrid("setGridParam", {
                            _iN: d
                        ...
                        var h = f.indexOf("</tr>");
                        if (f = f.slice(h + 5), $.isFunction(b.beforeSetItem) && (c = b.beforeSetItem.call(g, e), null != c && (e = c)), b.debug) {
                            ...
                            j = URL.createObjectURL(i), $("#link_save").attr("href", j).bind("click", function() {
                                $(this).remove()
                            })
                        }
                        ...
                        if (b.useStorage && $.jgrid.isLocalStorage()) try {
                            ...
                            22 === m.code && alert("Local storage limit is over!")
                        }
                        return e
                    }
                }
                ...
                if (c = $.extend({
                    ...
                    if (b) {
                        ...
                        if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
                            ...
                            if (m[0].refreshIndex(), d.subGrid) {
                                var o = 1 === d.multiselect ? 1 : 0,
                                    p = d.rownumbers === !0 ? 1 : 0;
                                m.jqGrid("addSubGrid", o + p)
                            }
                            if (d.treeGrid)
                                for (var q = 1, r = m[0].rows.length, s = d.expColInd, t = d.treeReader.leaf_field, u = d.treeReader.expanded_field; r > q;) $(m[0].rows[q].cells[s]).find("div.treeclick").bind("click", function(a) {
                                    var b = a.target || a.srcElement,
                                        c = $.jgrid.stripPref(d.idPrefix, $(b, m[0].rows).closest("tr.jqgrow")[0].id),
                                        e = m[0].p._index[c];
                                    return m[0].p.data[e][t] || (m[0].p.data[e][u] ? (m.jqGrid("collapseRow", m[0].p.data[e]), m.jqGrid("collapseNode", m[0].p.data[e])) : (m.jqGrid("expandRow", m[0].p.data[e]), m.jqGrid("expandNode", m[0].p.data[e]))), !1
                                }), d.ExpandColClick === !0 && $(m[0].rows[q].cells[s]).find("span.cell-wrapper").css("cursor", "pointer").bind("click", function(a) {
                                    var b = a.target || a.srcElement,
                                        c = $.jgrid.stripPref(d.idPrefix, $(b, m[0].rows).closest("tr.jqgrow")[0].id),
                                        e = m[0].p._index[c];
                                    return m[0].p.data[e][t] || (m[0].p.data[e][u] ? (m.jqGrid("collapseRow", m[0].p.data[e]), m.jqGrid("collapseNode", m[0].p.data[e])) : (m.jqGrid("expandRow", m[0].p.data[e]), m.jqGrid("expandNode", m[0].p.data[e]))), m.jqGrid("setSelection", c), !1
                                }), q++;
                ...
                return this.each(function() {
                    if (this.grid) {
                        ...
                        switch (c.rownumbers && (c.colNames.splice(0, 1), c.colModel.splice(0, 1)), c.multiselect && (c.colNames.splice(0, 1), c.colModel.splice(0, 1)), c.subGrid && (c.colNames.splice(0, 1), c.colModel.splice(0, 1)), c.knv = null, a.exptype) {
                            case "xmlstring":
                                b = "<" + a.root + ">" + jqGridUtils.jsonToXML(c, {
                                    xmlDecl: ""
                                }) + "</" + a.root + ">";
                                break;
                            case "jsonstring":
                                b = jqGridUtils.stringify(c), a.root && (b = "{" + a.root + ":" + b + "}")
                        }
                    }
                }), b
            },
                        ...
                        if ("remote" === a.exptype) {
                            ...
                            if (a.exporthidden) {
                                var f, g = this.p.colModel,
                                    h = g.length,
                                    i = [];
                                for (f = 0; h > f; f++) void 0 === g[f].hidden && (g[f].hidden = !1), i.push({
                                    name: g[f].name,
                                    hidden: g[f].hidden
                                });
                            ...
                            a.exportgrouping && (c = JSON.stringify(this.p.groupingView), "string" == typeof c && (d.groupingView = c));
            ...
            editRow: function(a, b, c, d, e, f, g, h, i) {
                ...
                return "object" === $.type(k[0]) ? j = k[0] : (void 0 !== b && (j.keys = b), $.isFunction(c) && (j.oneditfunc = c), $.isFunction(d) && (j.successfunc = d), void 0 !== e && (j.url = e), void 0 !== f && (j.extraparam = f), $.isFunction(g) && (j.aftersavefunc = g), $.isFunction(h) && (j.errorfunc = h), $.isFunction(i) && (j.afterrestorefunc = i)), j = $.extend(!0, {
                    ...
                    if (h.grid && (e = $(h).jqGrid("getInd", a, !0), e !== !1)) {
                        if (h.p.beforeAction = !0, g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0, void 0 === g && (g = !0), !g) return void(h.p.beforeAction = !1);
                        d = $(e).attr("editable") || "0", "0" !== d || $(e).hasClass("not-editable-row") || (f = h.p.colModel, $('td[role="gridcell"]', e).each(function(d) {
                            b = f[d].name;
            ...
            inlineNav: function(a, b) {
                ...
                return b = $.extend(!0, {
                    ...
                    if (this.grid && !this.p.inlineNav) {
                        ...
                        }), $("#" + e + "_ilcancel").addClass(f)), (b.restoreAfterSelect === !0 || b.saveAfterSelect === !0) && $(c).bind("jqGridBeforeSelectRow.inlineNav", function(a, d) {
                            c.p.savedRow.length > 0 && c.p.inlineNav === !0 && d !== c.p.selrow && null !== c.p.selrow && (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : b.restoreAfterSelect === !0 ? $(c).jqGrid("restoreRow", c.p.selrow, b.editParams) : $(c).jqGrid("saveRow", c.p.selrow, b.editParams), $(c).jqGrid("showAddEditButtons"))
                        })
                    }
                })
            },
    ...
    $.jgrid.extend({
            ...
            return this.each(function() {
                function e(a) {
                    var d, e, g, h, i = jQuery(f).jqGrid("pivotSetup", a, b),
                        j = $.assocArraySize(i.summary) > 0 ? !0 : !1,
        ...
        addSubGrid: function(a, b) {
            return this.each(function() {
                ...
                if (c.grid) {
                    ...
                    for (void 0 !== b && b > 0 && (r = b, q = b + 1); q > r;) {
                        if ($(c.rows[r]).hasClass("jqgrow")) {
                            if (c.p.scroll && $(c.rows[r].cells[a]).unbind("click"), p = null, s) var p = c.p.isHasSubGrid.call(c, c.rows[r].id);
                            p === !1 ? c.rows[r].cells[a].innerHTML = "" : $(c.rows[r].cells[a]).bind("click", function() {
                    ...
                    switch (d.p.treeGridModel) {
                        case "nested":
                            var h = d.p.treeReader.left_field,
                                ...
                                l = parseInt(a[i], 10),
                                m = parseInt(a[j], 10);
                            for (e = 0; g > e; e++) f = b ? d.p.data[d.p._index[this.rows[e].id]] : d.p.data[e], f && parseInt(f[j], 10) === m + 1 && parseInt(f[h], 10) > k && parseInt(f[i], 10) < l && c.push(f);
                            break;
                        case "adjacency":
                            var n = d.p.treeReader.parent_id_field,
                                o = d.p.localReader.id;
                            for (e = 0; g > e; e++) f = b ? d.p.data[d.p._index[this.rows[e].id]] : d.p.data[e], f && String(f[n]) === $.jgrid.stripPref(d.p.idPrefix, a[o]) && c.push(f)
                    }
                }
            }), c
        },
        ...
        getNodeAncestors: function(a, b, c) {
            ...
            return void 0 === b && (b = !1), this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    c = void 0 === c ? !1 : this.p.treeReader.expanded_field;
        ...
        setLeaf: function(a, b, c) {
            return this.each(function() {
                ...
                if (b === !0) $("div.treeclick", e).removeClass(this.p.treeIcons.minus + " tree-minus " + this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.leaf + " tree-leaf");
                else if (b === !1) {
                    var i = this.p.treeIcons.minus + " tree-minus";
                    c && (i = this.p.treeIcons.plus + " tree-plus"), $("div.treeclick", e).removeClass(this.p.treeIcons.leaf + " tree-leaf").addClass(i)
                }
            })
        },
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var c = this.p.localReader.id,
                        d = this.p.selrow;
                    $(this).jqGrid("delChildren", a[c]), void 0 === b && (b = !1), b || jQuery._data(this, "events").jqGridAfterSetTreeNode || $(this).bind("jqGridAfterSetTreeNode.reloadNode", function() {
                ...
                if (this.grid && this.p.treeGrid && h)
                    for (b = this.p.localReader.id; h--;)
                        if (i = $(this).jqGrid("getNodeAncestors", a[h], !0, !0), i.push(a[h]), c = i[0][b], -1 === $.inArray(c, j)) j.push(c), k = k.concat(i);
                            ...
                            for (f = 0, d = i.length; d > f; f++) {
                                var l = !1;
                                for (g = 0, e = k.length; e > g; g++)
                                    if (i[f][b] === k[g][b]) {
                                        l = !0;
                                        break
                                    }
        ...
        collectChildrenSortTree: function(a, b, c, d, e, f) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var g, h, i, j, k, l;
                    for (j = $(this).jqGrid("getNodeChildren", b, this.p.search), k = $.jgrid.from.call(this, j), k.orderBy(c, d, e, f), l = k.select(), g = 0, h = l.length; h > g; g++) i = l[g], a.push(i), $(this).jqGrid("collectChildrenSortTree", a, i, c, d, e, f)
                }
            })
        },
    ...
    $.fn.html5sortable = function(a) {
        ...
        return a = $.extend({
            ...
            if (/^enable|disable|destroy$/.test(b)) {
                var c = $(this).children($(this).data("items")).attr("draggable", "enable" === b);
                return void("destroy" === b && c.add(this).removeData("connectWith items").off("dragstart.h5s dragend.h5s selectstart.h5s dragover.h5s dragenter.h5s drop.h5s"))
            }
            var d, e, c = $(this).children(a.items),
                f = $("<" + (/^ul|ol$/i.test(this.tagName) ? "li" : /^tbody$/i.test(this.tagName) ? "tr" : "div") + ' class="sortable-placeholder ' + a.placeholderClass + '">').html("&nbsp;");
